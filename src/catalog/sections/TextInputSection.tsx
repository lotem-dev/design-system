...
const STYLE_ROWS: StyleRow[] = [
  { prop: "disabled", value: "false", cssClass: ".input",          properties: ["border: 1px solid var(--stroke-secondary)", "background: var(--surface-primary)", "transition: border-color 120ms"] },
  { prop: "disabled", value: "true",  cssClass: ".input:disabled", properties: ["background: var(--surface-secondary)", "color: var(--text-secondary)", "cursor: not-allowed"] },
];
          ...
          <tbody>
            <tr>
              <td style={{ ...TD, whiteSpace: "nowrap" }}>
                <code style={{ fontSize: "12px", fontFamily: "monospace", color: "#18181B", backgroundColor: "#F4F4F5", padding: "2px 6px", borderRadius: "4px" }}>.input</code>
              </td>
              <td style={TD}>
                {[
                  "composes: body",
  ...
  return (
    <SplitPage files={sources}>
      ...
      <SectionBlock title="Props">
        <PropsTable source={textInputTsx} />
      </SectionBlock>
    </SplitPage>
  );
}
