  ...
  return (
    <div>
      <div style={{ marginBottom: "32px" }}>
        ...
        <h1 style={{ margin: "8px 0 12px", fontSize: "28px", fontWeight: 700, color: "#09090B", fontFamily: "system-ui" }}>Divider</h1>
      ...
      <SectionBlock title="Preview">
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          <div>
            <p style={{ margin: "0 0 12px", fontSize: "12px", color: "#71717A", fontFamily: "system-ui" }}>Horizontal</p>
            <PreviewBox>
              <div style={{ width: "100%", display: "flex", flexDirection: "column" }}>
                <span style={{ fontSize: "13px", color: "#52525B", fontFamily: "system-ui" }}>Section A</span>
                <Divider orientation="horizontal" />
                <span style={{ fontSize: "13px", color: "#52525B", fontFamily: "system-ui" }}>Section B</span>
              </div>
            </PreviewBox>
          </div>
          <div>
            <p style={{ margin: "0 0 12px", fontSize: "12px", color: "#71717A", fontFamily: "system-ui" }}>Vertical</p>
            <PreviewBox>
              <div style={{ display: "flex", alignItems: "center", height: "48px" }}>
                <span style={{ fontSize: "13px", color: "#52525B", fontFamily: "system-ui" }}>Item A</span>
                <Divider orientation="vertical" />
                <span style={{ fontSize: "13px", color: "#52525B", fontFamily: "system-ui" }}>Item B</span>
              </div>
            </PreviewBox>
          </div>
        </div>
