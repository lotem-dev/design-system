...
import paginationTsx from "../../../components/atoms/Pagination.tsx?raw";
import paginationCss from "../../../components/atoms/Pagination.module.css?raw";
  ...
  return (
    <SplitPage files={sources}>
      <div style={{ marginBottom: "32px" }}>
        <span style={{ fontSize: "11px", fontWeight: 600, color: "#71717A", textTransform: "uppercase", letterSpacing: "0.08em", fontFamily: "'Open Sans', system-ui, sans-serif" }}>Data</span>
