...
import checkboxTsx from "../../../components/interactions/Checkbox.tsx?raw";
import checkboxCss from "../../../components/interactions/Checkbox.module.css?raw";
        ...
        controls={
          <>
            <ControlRow label="State">
              <Pill active={!checked} onClick={() => onChecked(false)}>unchecked</Pill>
              <Pill active={checked}  onClick={() => onChecked(true)}>checked</Pill>
            </ControlRow>
...
const STYLE_ROWS: StyleRow[] = [
  // checked state
  { prop: "checked", value: "false", cssClass: ".box",         properties: ["background: var(--surface-primary)", "border: 1px solid var(--stroke-secondary)"] },
  { prop: "checked", value: "true",  cssClass: ".box.checked", properties: ["background: var(--brand-primary)", "border-color: var(--brand-primary)"] },
  // disabled
          ...
          <tbody>
            <tr>
              <td style={{ ...TD, whiteSpace: "nowrap" }}>
                <code style={{ fontSize: "12px", fontFamily: "monospace", color: "#18181B", backgroundColor: "#F4F4F5", padding: "2px 6px", borderRadius: "4px" }}>.box</code>
              </td>
              <td style={TD}>
                {["width: 16px", "height: 16px", "border-radius: var(--radius-xs)", "transition: background 120ms ease, border-color 120ms ease"].map(p => (
            ...
            <tr>
              <td style={{ ...TD, whiteSpace: "nowrap" }}>
                <code style={{ fontSize: "12px", fontFamily: "monospace", color: "#18181B", backgroundColor: "#F4F4F5", padding: "2px 6px", borderRadius: "4px" }}>:focus-within .box</code>
              </td>
              <td style={TD}>
