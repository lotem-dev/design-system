  ...
  return (
    <SplitPage files={sources}>
      ...
      <SectionBlock title="Usage">
        <CodeBlock code={`import { BadgeSeverity } from "./components/atoms";

<BadgeSeverity scale="critical" />
<BadgeSeverity scale="high" />
<BadgeSeverity scale="medium" />
<BadgeSeverity scale="low" />

{/* Small size for tables */}
<BadgeSeverity scale="critical" size="sm" />`} />
      </SectionBlock>
    </SplitPage>
  );
}
